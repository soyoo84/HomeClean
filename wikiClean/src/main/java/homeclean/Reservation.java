...
import wikiClean.src.homeclean.Registered;
...
public class Reservation {
    ...
    public void onStatusUpdate(){
        ...
        if(this.getStatus().equals("RSV")){  //reservation
            homeclean.Reserved reserved = new homeclean.Reserved(this);
            BeanUtils.copyProperties(this, reserved);
            reserved.publish();
        }else if(this.getStatus().equals("CCL")){ //cancel
            homeclean.ReservationCancel reservationCanceled = new homeclean.ReservationCancel(this);
